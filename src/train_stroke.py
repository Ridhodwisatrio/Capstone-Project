...
# Load Data
X_train = pd.read_csv('../data/X_train_smote_Stroke.csv')
y_train = pd.read_csv('../data/y_train_smote_Stroke.csv').values.flatten()
...
joblib.dump(scaler, "../model/scaler_Stroke.pkl")
...
def train_model(X_train, y_train, X_test, y_test, epochs=50):
    ...
    target_names = ['Non-Stroke (Sehat)', 'Stroke']
    print("\n=== PERFORMANCE REPORT PENYAKIT STROKE ===")
...
trained_model.save("../model/Stroke_model.keras")